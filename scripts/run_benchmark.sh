...
python main.py --data_test Set5+Set14+B100+Urban100+Manga109+DIV2K --data_range 801-900 --scale 2 --n_resblocks 16 --n_feats 64 --res_scale 0.1 --pre_train ../experiment/edsr_baseline_x2/model/model_best.pt --test_only --save_results --save edsr_baseline_x2/results --ext sep