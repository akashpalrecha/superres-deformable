...
echo "---- BEGIN TRAINING ----"
echo ""
python main.py --model cgc_edsr --res_scale 0.1 --scale 2 --ext sep --save_results --save cgc_full_edsr_baseline_x2 --epochs 100
echo ""
...
python main.py --model cgc_edsr --res_scale 0.1 --scale 2 --ext sep --save_results --save cgc_full_edsr_baseline_x2/results --pre_train ../experiment/cgc_full_edsr_baseline_x2/model/model_best.pt --test_only --data_test Set5+Set14+B100+Urban100+Manga109+DIV2K --data_range 801-900
echo ""

echo "Start MATLAB Testing"
echo ""
cd ../scripts/matlab_evaluation
./benchmark_eval.sh 2 cgc_full_edsr_baseline_x2/results
echo ""
